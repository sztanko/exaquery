...
module.exports = React.createClass
  ...
  render: ->
    <div>
      ...
      <textarea>Some textarea here...</textarea>
      <input type="button" value="I am an input button"/>
      <input type="checkbox">test</input>
      <label><input type="checkbox"/>What about us, checkboxes?</label>
      <label><input type="radio"/> and radio buttons?</label>
      <select><option>one</option><option>Two</option></select>
      <button>I am a button button</button>
      </form>
      <hr />
